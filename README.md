...
This gamemode is still being worked on and has some bugs/incomplete features that need to be ironed out before it's ready for this.  If you're interested in packing it into your map please let me know.
